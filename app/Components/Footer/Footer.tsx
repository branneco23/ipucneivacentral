        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 pb-15">
          ...
          <div className="footer-content py-3">
            <ul className='footer-links flex flex-col'>
              <Link href="/" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>
                Inicio
              </Link>
              <Link href="/Pages/Services" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>
                Servicios
              </Link>
              <Link href="/Comites" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>
                Directivas
              </Link>
              <Link href="/Blogs" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>
                Doctrinas
              </Link>
              <Link href="/Transmision" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>
                Transmisiones
              </Link>
              <Link href="/Pages/Peticiones" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>
                Peticiones
              </Link>
              <Link href="/About" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>
                Contactenos
              </Link>
            </ul>
          </div>
          <div className="footer-content py-3">
            <ul className='footer-links flex flex-col'>
              ...
              <Link href="/" className='text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:lm-2'>Directiva de Familia</Link>
            </ul>
          </div>
          <div className='footer-content py-3 flex flex-col'>
            ...
            <div className="footer-social flex gap-4 py-6">
              ...
              <a
                ...
                className="flex items-center gap-4 text-gray-300 hover:text-(--prim) transition font-semibold"
              >
                <FaFacebook />
                Facebook
              </a>
